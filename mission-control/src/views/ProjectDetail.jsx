...
export default function ProjectDetail({ project, onBack }) {
  ...
  function buildConfirmationPrompt() {
    return [
      ...
      `- After each draft, you call collective__one to score it 1-10. Then you call collective__projects to record the iteration. One is the scorer only — it does not do research or writing.`,
  ...
  function buildKickoffPrompt() {
    return [
      ...
      `2. **Draft** — write or revise the document from your summaries.`,
      `3. **Judge** — call collective__one immediately (no text before the tool call). Pass the full document, the objective, and ask One to score 1-10 and identify the weakest section.`,
      ...
      ``,
      `**CRITICAL RULE: Never write "Now I will..." or "Next I will..." or any narration before a tool call. After each step, immediately execute the next tool call.**`,
      ``,
      `**Rules:**`,
